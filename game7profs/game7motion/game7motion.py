...
loud_explosion = pygame.mixer.Sound("../assets/sounds/mixkit-truck-crash-with-explosion-1616.wav")
soft_explosion = pygame.mixer.Sound("../assets/sounds/mixkit-fast-game-explosion-1688.wav")
    ...
    for bullet in bullets:
        ...
        for enemy in enemies:
            ...
            if bullet_enemy: # enemy is killed?
                pygame.mixer.Sound.play(loud_explosion)
        ...
        for fish in fishes:
            ...
            if bullet_fish:
                pygame.mixer.Sound.play(soft_explosion)

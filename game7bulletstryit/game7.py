...
from math import atan2 #no 2 means it'll give you abs value
...
bulletsound =pygame.mixer.Sound("../assets/sounds/bullets.wav")
bkg = pygame.mixer.Sound("../assets/sounds/backgroundmusic.wav")
